...
class MacedonPass extends StatefulWidget {
  @override
  _MacedonPassState createState() => _MacedonPassState();
}

class _MacedonPassState extends State<MacedonPass> {
